# This code is for M5StickV of LabCam.
# The code is based on Brownie Learn of Maker Faire Taipei 2019 Kit by ミクミンP/Kazuhiro Sasao.
# https://github.com/ksasao/brownie/releases
# Special thanks to ミクミンP/Kazuhiro Sasao.
# To connect with M5stickC, the code was modified as shown with markout.
...
try:
    while(True):
        ...
        #print(clock.fps())
        if dist < 100 and name != "exclude":      #50 is modified from original value 200
